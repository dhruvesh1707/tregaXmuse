...
// Release signing reads the local android/key.properties (gitignored, never
// committed). The Play Console AAB must be signed with the upload keystore,
// not debug keys.
